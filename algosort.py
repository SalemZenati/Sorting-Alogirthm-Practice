...
def draw(draw_info, algo_name, ascending):
    ...
    draw_info.window.blit(controls, (draw_info.width/2 - controls.get_width()/2 , 85))

    sorting = draw_info.FONT.render("I - Insertion Sort | B - Bubble Sort", 1, draw_info.BLACK)
    draw_info.window.blit(sorting, (draw_info.width/2 - sorting.get_width()/2 , 105))\
     
    sortSpace = draw_info.MEDIUM_FONT.render("Start Sorting! : SPACE", 1, draw_info.BLACK)
    draw_info.window.blit(sortSpace, (draw_info.width/2 - sortSpace.get_width()/2 , 155))\
